...
- **Продвинутое извлечение имени картинки**:
  ...
  - Умное определение окна источника: безошибочно определяет активное приложение даже при работе с несколькими мониторами (по окну под курсором мыши).
  - Распознает прямые текстовые ссылки на изображения.
- **Гибкие настройки**:
  - Управление показом пункта "Буфер обмена" в контекстном меню
  - Настройка действия при клике на значок в трее
  - Переключение классического меню Windows 11
